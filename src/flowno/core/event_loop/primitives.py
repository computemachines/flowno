...
@coroutine
def spawn(raw_task: RawTask[Any, Any, _T_co]) -> Generator[
    SpawnCommand[_T_co],
...
@overload
async def azip(
    iterable1: AsyncIterator[_T1], iterable2: AsyncIterator[_T2], /
) -> AsyncGenerator[tuple[_T1, _T2], None]: ...


@overload
async def azip(
    iterable1: AsyncIterator[_T1], iterable2: AsyncIterator[_T2], iterable3: AsyncIterator[_T3], /
) -> AsyncGenerator[tuple[_T1, _T2, _T3], None]: ...
