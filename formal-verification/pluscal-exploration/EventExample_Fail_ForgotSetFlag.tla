------------------------ MODULE EventExample_Fail_ForgotSetFlag ------------------------
(*
 * PURPOSE: NEGATIVE TEST - Forgot to set eventSet flag
 * EXPECTED: Should violate SetEventNoWaiters or cause deadlock/liveness failure
 *
      ...
      handle:
        while (TRUE) {
            ...
            if (pendingCommand.cmd = "Spawn") {
                ...
                \* BUG: Forgot to set the event flag!
                \* eventSet := TRUE;
                taskState := [t \in Tasks |->
                    IF t \in eventWaiters THEN "ReadyResuming"
                    ELSE IF t = pendingCommand.task THEN "Ready"
                    ELSE taskState[t]];
                \* Clear all waiters (all woken)
                eventWaiters := {};
            }
...
handle == /\ pc[98] = "handle"
          ...
          /\ IF pendingCommand.cmd = "Spawn"
                THEN /\ taskState' =          [t \in Tasks |->
                                     ...
                                     ELSE IF t = pendingCommand.task THEN "Ready"
                                     ELSE taskState[t]]
                     /\ UNCHANGED << joinWaiters, eventWaiters >>
                ELSE /\ IF pendingCommand.cmd = "Join"
          ...
          /\ UNCHANGED << running, eventSet, waiterReceived, setterCompleted >>
...
main_spawn_waiter(self) == /\ pc[self] = "main_spawn_waiter"
                           /\ running = self
                           /\ Assert(pendingCommand = NoCmd, 
                                     "Failure of assertion at line 145, column 9 of macro called at line 280, column 9.")
                           /\ Assert(running = self, 
                                     "Failure of assertion at line 146, column 9 of macro called at line 280, column 9.")
                           /\ Assert(taskState[self] = "Running", 
                                     "Failure of assertion at line 147, column 9 of macro called at line 280, column 9.")
...
main_spawn_setter(self) == /\ pc[self] = "main_spawn_setter"
                           /\ running = self
                           /\ Assert(pendingCommand = NoCmd, 
                                     "Failure of assertion at line 145, column 9 of macro called at line 284, column 9.")
                           /\ Assert(running = self, 
                                     "Failure of assertion at line 146, column 9 of macro called at line 284, column 9.")
                           /\ Assert(taskState[self] = "Running", 
                                     "Failure of assertion at line 147, column 9 of macro called at line 284, column 9.")
...
main_join_waiter(self) == /\ pc[self] = "main_join_waiter"
                          /\ running = self
                          /\ Assert(pendingCommand = NoCmd, 
                                    "Failure of assertion at line 153, column 9 of macro called at line 288, column 9.")
                          /\ Assert(running = self, 
                                    "Failure of assertion at line 154, column 9 of macro called at line 288, column 9.")
                          /\ Assert(taskState[self] = "Running", 
                                    "Failure of assertion at line 155, column 9 of macro called at line 288, column 9.")
...
main_join_setter(self) == /\ pc[self] = "main_join_setter"
                          /\ running = self
                          /\ Assert(pendingCommand = NoCmd, 
                                    "Failure of assertion at line 153, column 9 of macro called at line 292, column 9.")
                          /\ Assert(running = self, 
                                    "Failure of assertion at line 154, column 9 of macro called at line 292, column 9.")
                          /\ Assert(taskState[self] = "Running", 
                                    "Failure of assertion at line 155, column 9 of macro called at line 292, column 9.")
...
main_complete(self) == /\ pc[self] = "main_complete"
                       /\ running = self
                       /\ Assert(pendingCommand = NoCmd, 
                                 "Failure of assertion at line 177, column 9 of macro called at line 296, column 9.")
                       /\ Assert(running = self, 
                                 "Failure of assertion at line 178, column 9 of macro called at line 296, column 9.")
                       /\ Assert(taskState[self] = "Running", 
                                 "Failure of assertion at line 179, column 9 of macro called at line 296, column 9.")
                       /\ pendingCommand' = [cmd |-> "Complete", task |-> self]
                       /\ running' = NoTask
...
waiter_wait(self) == /\ pc[self] = "waiter_wait"
                     /\ running = self
                     /\ Assert(pendingCommand = NoCmd, 
                               "Failure of assertion at line 161, column 9 of macro called at line 304, column 9.")
                     /\ Assert(running = self, 
                               "Failure of assertion at line 162, column 9 of macro called at line 304, column 9.")
                     /\ Assert(taskState[self] = "Running", 
                               "Failure of assertion at line 163, column 9 of macro called at line 304, column 9.")
                     /\ pendingCommand' = [cmd |-> "EventWait", task |-> self]
                     /\ running' = NoTask
...
waiter_complete(self) == /\ pc[self] = "waiter_complete"
                         /\ running = self
                         /\ Assert(pendingCommand = NoCmd, 
                                   "Failure of assertion at line 177, column 9 of macro called at line 312, column 9.")
                         /\ Assert(running = self, 
                                   "Failure of assertion at line 178, column 9 of macro called at line 312, column 9.")
                         /\ Assert(taskState[self] = "Running", 
                                   "Failure of assertion at line 179, column 9 of macro called at line 312, column 9.")
                         /\ pendingCommand' = [cmd |-> "Complete", task |-> self]
                         /\ running' = NoTask
                         /\ pc' = [pc EXCEPT ![self] = "Done"]
                         /\ UNCHANGED << taskState, joinWaiters, eventSet, 
...
setter_set(self) == /\ pc[self] = "setter_set"
                    /\ running = self
                    /\ Assert(pendingCommand = NoCmd, 
                              "Failure of assertion at line 169, column 9 of macro called at line 320, column 9.")
                    /\ Assert(running = self, 
                              "Failure of assertion at line 170, column 9 of macro called at line 320, column 9.")
                    /\ Assert(taskState[self] = "Running", 
                              "Failure of assertion at line 171, column 9 of macro called at line 320, column 9.")
                    /\ pendingCommand' = [cmd |-> "EventSet", task |-> self]
                    /\ running' = NoTask
...
setter_complete(self) == /\ pc[self] = "setter_complete"
                         /\ running = self
                         /\ Assert(pendingCommand = NoCmd, 
                                   "Failure of assertion at line 177, column 9 of macro called at line 328, column 9.")
                         /\ Assert(running = self, 
                                   "Failure of assertion at line 178, column 9 of macro called at line 328, column 9.")
                         /\ Assert(taskState[self] = "Running", 
                                   "Failure of assertion at line 179, column 9 of macro called at line 328, column 9.")
                         /\ pendingCommand' = [cmd |-> "Complete", task |-> self]
                         /\ running' = NoTask
                         /\ pc' = [pc EXCEPT ![self] = "Done"]
                         /\ UNCHANGED << taskState, joinWaiters, eventSet, 
