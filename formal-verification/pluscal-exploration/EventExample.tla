------------------------ MODULE EventExample ------------------------
(*
 * PURPOSE: Formal verification of Flowno's Event synchronization primitive
 *
...
sched == /\ pc[99] = "sched"
         ...
         /\ \E t \in {t \in Tasks : IsSchedulable(t)}:
              /\ Assert(~\E t2 \in Tasks : taskState[t2] = "Running", 
                        "Failure of assertion at line 194, column 17.")
              /\ running' = t
...
main_spawn_waiter(self) == /\ pc[self] = "main_spawn_waiter"
                           /\ running = self
                           /\ Assert(pendingCommand = NoCmd, 
                                     "Failure of assertion at line 144, column 9 of macro called at line 278, column 9.")
                           /\ Assert(running = self, 
...
main_spawn_setter(self) == /\ pc[self] = "main_spawn_setter"
                           /\ running = self
                           /\ Assert(pendingCommand = NoCmd, 
                                     "Failure of assertion at line 144, column 9 of macro called at line 282, column 9.")
                           /\ Assert(running = self, 
                                     "Failure of assertion at line 145, column 9 of macro called at line 282, column 9.")
                           /\ Assert(taskState[self] = "Running", 
                                     "Failure of assertion at line 146, column 9 of macro called at line 282, column 9.")
...
main_join_waiter(self) == /\ pc[self] = "main_join_waiter"
                          /\ running = self
                          /\ Assert(pendingCommand = NoCmd, 
                                    "Failure of assertion at line 152, column 9 of macro called at line 286, column 9.")
                          /\ Assert(running = self, 
...
main_join_setter(self) == /\ pc[self] = "main_join_setter"
                          /\ running = self
                          /\ Assert(pendingCommand = NoCmd, 
                                    "Failure of assertion at line 152, column 9 of macro called at line 290, column 9.")
                          /\ Assert(running = self, 
                                    "Failure of assertion at line 153, column 9 of macro called at line 290, column 9.")
                          /\ Assert(taskState[self] = "Running", 
                                    "Failure of assertion at line 154, column 9 of macro called at line 290, column 9.")
...
main_complete(self) == /\ pc[self] = "main_complete"
                       /\ running = self
                       /\ Assert(pendingCommand = NoCmd, 
                                 "Failure of assertion at line 176, column 9 of macro called at line 294, column 9.")
                       /\ Assert(running = self, 
                                 "Failure of assertion at line 177, column 9 of macro called at line 294, column 9.")
                       /\ Assert(taskState[self] = "Running", 
                                 "Failure of assertion at line 178, column 9 of macro called at line 294, column 9.")
                       /\ pendingCommand' = [cmd |-> "Complete", task |-> self]
                       /\ running' = NoTask
...
waiter_wait(self) == /\ pc[self] = "waiter_wait"
                     /\ running = self
                     /\ Assert(pendingCommand = NoCmd, 
                               "Failure of assertion at line 160, column 9 of macro called at line 302, column 9.")
                     /\ Assert(running = self, 
                               "Failure of assertion at line 161, column 9 of macro called at line 302, column 9.")
                     /\ Assert(taskState[self] = "Running", 
                               "Failure of assertion at line 162, column 9 of macro called at line 302, column 9.")
                     /\ pendingCommand' = [cmd |-> "EventWait", task |-> self]
                     /\ running' = NoTask
...
waiter_complete(self) == /\ pc[self] = "waiter_complete"
                         /\ running = self
                         /\ Assert(pendingCommand = NoCmd, 
                                   "Failure of assertion at line 176, column 9 of macro called at line 310, column 9.")
                         /\ Assert(running = self, 
                                   "Failure of assertion at line 177, column 9 of macro called at line 310, column 9.")
                         /\ Assert(taskState[self] = "Running", 
                                   "Failure of assertion at line 178, column 9 of macro called at line 310, column 9.")
                         /\ pendingCommand' = [cmd |-> "Complete", task |-> self]
                         /\ running' = NoTask
                         /\ pc' = [pc EXCEPT ![self] = "Done"]
                         /\ UNCHANGED << taskState, joinWaiters, eventSet, 
...
setter_set(self) == /\ pc[self] = "setter_set"
                    /\ running = self
                    /\ Assert(pendingCommand = NoCmd, 
                              "Failure of assertion at line 168, column 9 of macro called at line 318, column 9.")
                    /\ Assert(running = self, 
                              "Failure of assertion at line 169, column 9 of macro called at line 318, column 9.")
                    /\ Assert(taskState[self] = "Running", 
                              "Failure of assertion at line 170, column 9 of macro called at line 318, column 9.")
                    /\ pendingCommand' = [cmd |-> "EventSet", task |-> self]
                    /\ running' = NoTask
...
setter_complete(self) == /\ pc[self] = "setter_complete"
                         /\ running = self
                         /\ Assert(pendingCommand = NoCmd, 
                                   "Failure of assertion at line 176, column 9 of macro called at line 326, column 9.")
                         /\ Assert(running = self, 
                                   "Failure of assertion at line 177, column 9 of macro called at line 326, column 9.")
                         /\ Assert(taskState[self] = "Running", 
                                   "Failure of assertion at line 178, column 9 of macro called at line 326, column 9.")
                         /\ pendingCommand' = [cmd |-> "Complete", task |-> self]
                         /\ running' = NoTask
                         /\ pc' = [pc EXCEPT ![self] = "Done"]
                         /\ UNCHANGED << taskState, joinWaiters, eventSet, 
