------------------------ MODULE EventExample_Fail_MissingFastPath ------------------------
(*
 * PURPOSE: NEGATIVE TEST - Missing fast path check in EventWait
      ...
      handle:
        while (TRUE) {
            ...
            if (pendingCommand.cmd = "Spawn") {
                ...
                \* BUG: Missing fast path check! Always blocks, even if event is already set.
...
handle == /\ pc[98] = "handle"
          ...
          /\ IF pendingCommand.cmd = "Spawn"
                ...
                ELSE /\ IF pendingCommand.cmd = "Join"
                           ...
                           ELSE /\ IF pendingCommand.cmd = "EventWait"
                                      THEN /\ taskState' = [taskState EXCEPT ![pendingCommand.task] = "WaitingEvent"]
                                           /\ eventWaiters' = (eventWaiters \union {pendingCommand.task})
                                           /\ UNCHANGED << joinWaiters, 
                                                           eventSet >>
                                      ELSE /\ IF pendingCommand.cmd = "EventSet"
...
main_spawn_waiter(self) == /\ pc[self] = "main_spawn_waiter"
                           /\ running = self
                           /\ Assert(pendingCommand = NoCmd, 
                                     "Failure of assertion at line 145, column 9 of macro called at line 274, column 9.")
                           /\ Assert(running = self, 
                                     "Failure of assertion at line 146, column 9 of macro called at line 274, column 9.")
                           /\ Assert(taskState[self] = "Running", 
                                     "Failure of assertion at line 147, column 9 of macro called at line 274, column 9.")
...
main_spawn_setter(self) == /\ pc[self] = "main_spawn_setter"
                           /\ running = self
                           /\ Assert(pendingCommand = NoCmd, 
                                     "Failure of assertion at line 145, column 9 of macro called at line 278, column 9.")
                           /\ Assert(running = self, 
                                     "Failure of assertion at line 146, column 9 of macro called at line 278, column 9.")
                           /\ Assert(taskState[self] = "Running", 
                                     "Failure of assertion at line 147, column 9 of macro called at line 278, column 9.")
...
main_join_waiter(self) == /\ pc[self] = "main_join_waiter"
                          /\ running = self
                          /\ Assert(pendingCommand = NoCmd, 
                                    "Failure of assertion at line 153, column 9 of macro called at line 282, column 9.")
                          /\ Assert(running = self, 
                                    "Failure of assertion at line 154, column 9 of macro called at line 282, column 9.")
                          /\ Assert(taskState[self] = "Running", 
                                    "Failure of assertion at line 155, column 9 of macro called at line 282, column 9.")
...
main_join_setter(self) == /\ pc[self] = "main_join_setter"
                          /\ running = self
                          /\ Assert(pendingCommand = NoCmd, 
                                    "Failure of assertion at line 153, column 9 of macro called at line 286, column 9.")
                          /\ Assert(running = self, 
                                    "Failure of assertion at line 154, column 9 of macro called at line 286, column 9.")
                          /\ Assert(taskState[self] = "Running", 
                                    "Failure of assertion at line 155, column 9 of macro called at line 286, column 9.")
...
main_complete(self) == /\ pc[self] = "main_complete"
                       /\ running = self
                       /\ Assert(pendingCommand = NoCmd, 
                                 "Failure of assertion at line 177, column 9 of macro called at line 290, column 9.")
                       /\ Assert(running = self, 
                                 "Failure of assertion at line 178, column 9 of macro called at line 290, column 9.")
                       /\ Assert(taskState[self] = "Running", 
                                 "Failure of assertion at line 179, column 9 of macro called at line 290, column 9.")
                       /\ pendingCommand' = [cmd |-> "Complete", task |-> self]
                       /\ running' = NoTask
...
waiter_wait(self) == /\ pc[self] = "waiter_wait"
                     /\ running = self
                     /\ Assert(pendingCommand = NoCmd, 
                               "Failure of assertion at line 161, column 9 of macro called at line 298, column 9.")
                     /\ Assert(running = self, 
                               "Failure of assertion at line 162, column 9 of macro called at line 298, column 9.")
                     /\ Assert(taskState[self] = "Running", 
                               "Failure of assertion at line 163, column 9 of macro called at line 298, column 9.")
                     /\ pendingCommand' = [cmd |-> "EventWait", task |-> self]
                     /\ running' = NoTask
...
waiter_complete(self) == /\ pc[self] = "waiter_complete"
                         /\ running = self
                         /\ Assert(pendingCommand = NoCmd, 
                                   "Failure of assertion at line 177, column 9 of macro called at line 306, column 9.")
                         /\ Assert(running = self, 
                                   "Failure of assertion at line 178, column 9 of macro called at line 306, column 9.")
                         /\ Assert(taskState[self] = "Running", 
                                   "Failure of assertion at line 179, column 9 of macro called at line 306, column 9.")
                         /\ pendingCommand' = [cmd |-> "Complete", task |-> self]
                         /\ running' = NoTask
                         /\ pc' = [pc EXCEPT ![self] = "Done"]
                         /\ UNCHANGED << taskState, joinWaiters, eventSet, 
...
setter_set(self) == /\ pc[self] = "setter_set"
                    /\ running = self
                    /\ Assert(pendingCommand = NoCmd, 
                              "Failure of assertion at line 169, column 9 of macro called at line 314, column 9.")
                    /\ Assert(running = self, 
                              "Failure of assertion at line 170, column 9 of macro called at line 314, column 9.")
                    /\ Assert(taskState[self] = "Running", 
                              "Failure of assertion at line 171, column 9 of macro called at line 314, column 9.")
                    /\ pendingCommand' = [cmd |-> "EventSet", task |-> self]
                    /\ running' = NoTask
...
setter_complete(self) == /\ pc[self] = "setter_complete"
                         /\ running = self
                         /\ Assert(pendingCommand = NoCmd, 
                                   "Failure of assertion at line 177, column 9 of macro called at line 322, column 9.")
                         /\ Assert(running = self, 
                                   "Failure of assertion at line 178, column 9 of macro called at line 322, column 9.")
                         /\ Assert(taskState[self] = "Running", 
                                   "Failure of assertion at line 179, column 9 of macro called at line 322, column 9.")
                         /\ pendingCommand' = [cmd |-> "Complete", task |-> self]
                         /\ running' = NoTask
                         /\ pc' = [pc EXCEPT ![self] = "Done"]
                         /\ UNCHANGED << taskState, joinWaiters, eventSet, 
