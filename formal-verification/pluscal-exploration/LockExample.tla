------------------------ MODULE LockExample ------------------------
(*
 * PURPOSE: Formal verification of Flowno's Lock synchronization primitive
 *
...
main_spawn1(self) == /\ pc[self] = "main_spawn1"
                     /\ running = self
                     /\ Assert(pendingCommand = NoCmd, 
                               "Failure of assertion at line 156, column 9 of macro called at line 292, column 9.")
                     /\ Assert(running = self, 
                               "Failure of assertion at line 157, column 9 of macro called at line 292, column 9.")
                     /\ Assert(taskState[self] = "Running", 
                               "Failure of assertion at line 158, column 9 of macro called at line 292, column 9.")
...
main_spawn2(self) == /\ pc[self] = "main_spawn2"
                     /\ running = self
                     /\ Assert(pendingCommand = NoCmd, 
                               "Failure of assertion at line 156, column 9 of macro called at line 296, column 9.")
                     /\ Assert(running = self, 
                               "Failure of assertion at line 157, column 9 of macro called at line 296, column 9.")
                     /\ Assert(taskState[self] = "Running", 
                               "Failure of assertion at line 158, column 9 of macro called at line 296, column 9.")
...
main_spawn3(self) == /\ pc[self] = "main_spawn3"
                     /\ running = self
                     /\ Assert(pendingCommand = NoCmd, 
                               "Failure of assertion at line 156, column 9 of macro called at line 300, column 9.")
                     /\ Assert(running = self, 
                               "Failure of assertion at line 157, column 9 of macro called at line 300, column 9.")
                     /\ Assert(taskState[self] = "Running", 
                               "Failure of assertion at line 158, column 9 of macro called at line 300, column 9.")
...
main_join1(self) == /\ pc[self] = "main_join1"
                    /\ running = self
                    /\ Assert(pendingCommand = NoCmd, 
                              "Failure of assertion at line 164, column 9 of macro called at line 304, column 9.")
                    /\ Assert(running = self, 
                              "Failure of assertion at line 165, column 9 of macro called at line 304, column 9.")
                    /\ Assert(taskState[self] = "Running", 
                              "Failure of assertion at line 166, column 9 of macro called at line 304, column 9.")
...
main_join2(self) == /\ pc[self] = "main_join2"
                    /\ running = self
                    /\ Assert(pendingCommand = NoCmd, 
                              "Failure of assertion at line 164, column 9 of macro called at line 308, column 9.")
                    /\ Assert(running = self, 
                              "Failure of assertion at line 165, column 9 of macro called at line 308, column 9.")
                    /\ Assert(taskState[self] = "Running", 
                              "Failure of assertion at line 166, column 9 of macro called at line 308, column 9.")
...
main_join3(self) == /\ pc[self] = "main_join3"
                    /\ running = self
                    /\ Assert(pendingCommand = NoCmd, 
                              "Failure of assertion at line 164, column 9 of macro called at line 312, column 9.")
                    /\ Assert(running = self, 
                              "Failure of assertion at line 165, column 9 of macro called at line 312, column 9.")
                    /\ Assert(taskState[self] = "Running", 
                              "Failure of assertion at line 166, column 9 of macro called at line 312, column 9.")
...
main_complete(self) == /\ pc[self] = "main_complete"
                       /\ running = self
                       /\ Assert(pendingCommand = NoCmd, 
                                 "Failure of assertion at line 188, column 9 of macro called at line 316, column 9.")
                       /\ Assert(running = self, 
                                 "Failure of assertion at line 189, column 9 of macro called at line 316, column 9.")
                       /\ Assert(taskState[self] = "Running", 
                                 "Failure of assertion at line 190, column 9 of macro called at line 316, column 9.")
                       /\ pendingCommand' = [cmd |-> "Complete", task |-> self]
                       /\ running' = NoTask
...
worker_acquire(self) == /\ pc[self] = "worker_acquire"
                        /\ running = self
                        /\ Assert(pendingCommand = NoCmd, 
                                  "Failure of assertion at line 172, column 9 of macro called at line 324, column 9.")
                        /\ Assert(running = self, 
                                  "Failure of assertion at line 173, column 9 of macro called at line 324, column 9.")
                        /\ Assert(taskState[self] = "Running", 
                                  "Failure of assertion at line 174, column 9 of macro called at line 324, column 9.")
                        /\ pendingCommand' = [cmd |-> "LockAcquire", task |-> self]
                        /\ running' = NoTask
...
worker_release(self) == /\ pc[self] = "worker_release"
                        /\ running = self
                        /\ Assert(pendingCommand = NoCmd, 
                                  "Failure of assertion at line 180, column 9 of macro called at line 342, column 9.")
                        /\ Assert(running = self, 
                                  "Failure of assertion at line 181, column 9 of macro called at line 342, column 9.")
                        /\ Assert(taskState[self] = "Running", 
                                  "Failure of assertion at line 182, column 9 of macro called at line 342, column 9.")
                        /\ pendingCommand' = [cmd |-> "LockRelease", task |-> self]
                        /\ running' = NoTask
...
worker_complete(self) == /\ pc[self] = "worker_complete"
                         /\ running = self
                         /\ Assert(pendingCommand = NoCmd, 
                                   "Failure of assertion at line 188, column 9 of macro called at line 346, column 9.")
                         /\ Assert(running = self, 
                                   "Failure of assertion at line 189, column 9 of macro called at line 346, column 9.")
                         /\ Assert(taskState[self] = "Running", 
                                   "Failure of assertion at line 190, column 9 of macro called at line 346, column 9.")
                         /\ pendingCommand' = [cmd |-> "Complete", task |-> self]
                         /\ running' = NoTask
                         /\ pc' = [pc EXCEPT ![self] = "Done"]
                         /\ UNCHANGED << taskState, joinWaiters, lockOwner, 
